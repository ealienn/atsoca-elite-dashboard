...
export function renderReferralFees(container) {
  ...
  container.innerHTML = `
    ...
    return `
      ...
      <div class="card">
        <div class="card-header">
          <div class="card-title"><i class="fas fa-calculator" style="color: var(--accent-cyan);"></i> Live Fee Calculator Simulator</div>
        </div>
        <form id="calc-sim-form">
          ...
          <div class="sim-result-card" id="sim-result-box">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
              <span class="sim-result-label" style="font-size: 0.82rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.03em;">Applicable Fee Bracket:</span>
              <span style="font-weight: 800; color: #38bdf8; font-size: 0.95rem;" id="sim-bracket-label">≥ ₱3,000</span>
            </div>
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
              <span class="sim-result-label" style="font-size: 0.82rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.03em;">Matrix Percentage Rate:</span>
              <span style="font-weight: 900; color: #34d399; font-size: 1.2rem;" id="sim-rate-label">18%</span>
            </div>
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
              <span class="sim-result-label" style="font-size: 0.82rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.03em;">Referral Fee per Pax:</span>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;" id="sim-volume-row">
              <span class="sim-result-label" style="font-size: 0.82rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.03em;">Total Net Investment Volume:</span>
              <span style="font-weight: 800; color: #38bdf8; font-size: 1.05rem;" id="sim-volume-label">₱4,500.00 (1 Pax)</span>
            </div>
            <div style="display: flex; justify-content: space-between; align-items: center; border-top: 2px dashed var(--border-color); padding-top: 14px; margin-top: 4px;">
              <div>
                <span style="color: var(--text-primary); font-weight: 800; font-size: 0.95rem; display: block;">Total Calculated Referral Fee:</span>
                <span style="font-size: 0.8rem; color: #c084fc; font-weight: 700;" id="sim-units-label">+1.00 Matrix Units Earned</span>
              </div>
              <span style="font-weight: 900; color: #fbbf24; font-size: 1.8rem; letter-spacing: -0.02em;" id="sim-total-label">₱810.00</span>
            </div>
          </div>
        </form>
      </div>
    ...
    <div class="card">
      <div class="card-header">
        <div class="card-title"><i class="fas fa-coins"></i> Verified Referrals Fee Statement</div>
      </div>
